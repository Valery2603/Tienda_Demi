<?php
    ...
    $query_verificar = "SELECT id_usuario FROM usuarios WHERE email = ?";
    ...
    if (empty($errores)) {
        ...
        $query_insertar = "INSERT INTO usuarios (email, password, nombre, id_rol) 
                           VALUES (?, ?, ?, ?)";                         
        $stmt_insertar = $db->prepare($query_insertar);
        $stmt_insertar->bind_param("sssi", $email, $contrasena_hasheada, $nombre, $id_rol);
        
        if ($stmt_insertar->execute()) {
            $stmt_insertar->close();
            header("Location: listausuario.php?resultado=1"); 
            exit();
        } else {
...
<body class='fondo adamina-regular'>
    ...
    <section class="contacto adamina-regular">
        <h1 class="card-title text-center mt-5 mb-3">Crear Usuario</h1>
        <?php
                            ...
                            <div class="col-12 col-lg-8">
                                ...
                                <div class="card p-4 shadow">
                                    ...
                                    <div class="mb-4 pt-2 div-relativo">
                                        ...
                                        <select name="rol" id="rol" class='mx-2' required>
                                            ...
                                            <?php
                                                ...
                                                <option
                                                    value='<?php echo $rol['id_rol']."' >".$rol['nombre_rol']."</option>";
                                            }
                                            ?>  
                                        </select>
                                    </div>
                                    ...
                                    <div class="botones col d-flex gap-5 pt-4 justify-content-center">
                                        <button type="submit" class="col-md-5 btn btn-success btn-registro disabled" >Crear
